...
import { CHECK_APPLIED_COUPON, COUPON_LIST_API, CREATE_ORDER, PRODUCT_DETAILS, PRODUCT_LIST_APT } from "../../../utils/constant";
import { ICoupon, ICouponApplied, ICouponReq, IOrderConfirmed, IOrderReq, IProduct, IProductDetail } from "./type";

export const productApi = {
    async productList(): Promise<IProduct[]> {
        return apiInstance
            .post(PRODUCT_LIST_APT)
            .then((response) => {
